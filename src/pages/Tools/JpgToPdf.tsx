...
import { ImagePlus, Download, Loader2, CheckCircle, ArrowLeft } from 'lucide-react';
      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        <div className="mb-12">
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <h1 className="text-4xl font-extrabold text-slate-900 dark:text-white mb-2">JPG to PDF</h1>
              <p className="text-slate-500 dark:text-slate-400 font-medium">Convert your images into a PDF document easily and for free.</p>
            </div>
          </div>
        </div>
        ...
        {!resultUrl ? (
          ...
          >
            ...
            <h2 className="text-4xl font-black text-slate-800 dark:text-white mb-4">Converted Successfully!</h2>
            <p className="text-slate-500 dark:text-slate-400 mb-10 font-medium text-lg">Your images have been converted to a PDF document.</p>
